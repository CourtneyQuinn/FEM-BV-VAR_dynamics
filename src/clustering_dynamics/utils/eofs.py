...
def _eofs_impl(*arrays, n_modes=None,
    ...
    *arrays : arrays of shape (N, ...)
    ...
    u, s, vh = calculate_truncated_svd(combined_dataset, k=n_modes)
    ...
    for i in range(n_input_arrays):
        ...
        eofs_results.append(eof_2d_components.reshape((n_modes,) + input_shape))
...
def _varimax_reofs_impl(*arrays, n_modes=None, n_rotated_modes=None,
    ...
    *arrays : arrays of shape (N, ...)
    ...
    for i in range(n_input_arrays):
        ...
        reofs_results.append(reof_2d_components.reshape(
